"""
Django settings for vuna_shop project.
...
SECRET_KEY = 'django-insecure-jsi26dh)(df5ecuj7f0-9zni4i*g62bs3^#$^(nqs=g)v8yvl1'
...
WSGI_APPLICATION = 'vuna_shop.wsgi.application'
